            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="container-fluid">
                        ...
                        <div class="page-section" style="padding:5px 0px;">
                            <div class="col-md-6">
                                <h1 class="text-display-1 margin-none" style="vertical-align:middle;">My Completed
                                    Course</h1>
                            </div>
                                ...
                                <form name="frm_searhc" id="frm_search" method="post" action="search.php">
                                    <div id="custom-search-input">
                                        <div class="input-group col-md-6 pull-right" style="padding-right:0px;">
                                            ...
                                            <input type="text" name="srch" class="  search-query form-control"
                ...
                <span class="btn btn-circle btn-orange-500 btn-lg"><i class="fa fa-play"></i></span>
                                        ...
                                        <div class="panel-body">
                                            <p class="text-headline margin-v-0-10"><a
                                                    ...
                                                    style="font-size:14px;"><?php echo $c_name; ?></a></p>
                                ...
                                <div class="media v-middle">
                                    ...
                                    <div class="media-right media-padding">
                                        <a class="btn btn-white paper-shadow relative" data-z="0.5" data-hover-z="1"
                                           data-animated href="my_courses.php">
                                            Go to My Courses
                                        </a>
                                    </div>
                                </div>
