                    ...
                    <div class="col-md-8">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <input type="text" name="full_name" class="form-control used" id="inputEmail3" placeholder="Your Full name" value="<?php echo $full_name;?>" required>
                    ...
                    <div class="col-md-6">
                      <div class="form-control-material">
                        <div class="input-group">
                          ...
                          <input type="email" name="email" class="form-control used" id="inputEmail3" placeholder="Email" value="<?php echo $email;?>" required>
