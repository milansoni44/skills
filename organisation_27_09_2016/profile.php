...
//	$status=$_POST['status'];
	...
	if($exist_number > 0){
		...
		$query ="UPDATE `user` SET `full_name`='$full_name',`email`='$email',`mobile`='$mobile',`u_name`='$u_name',`password`='$password',`dob`='$dob',`state`='$state',`country`='$country',`education`='$education',`occupation`='$occupation',`phone`='$phone',`contact_person`= '$contact'";
                    ...
                    <div class="col-md-8">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <input type="text" name="full_name" class="form-control used" id="inputEmail3" placeholder="Your company name" value="<?php echo $full_name;?>">
