    ...
    <div class="page-section">
      <div class="row">
        ...
        <div class="col-md-9">
			...
			?>
            <div class="item col-xs-12 col-sm-6 col-lg-4 col-md-4">
                ...
                <span class="btn btn-circle btn-orange-500 btn-lg"><i class="fa fa-play"></i></span>
                  ...
                  <div class="panel-body" align="center">
                    ...
                    <a class="btn btn-deep-orange-500 btn-flat paper-shadow relative" data-z="0" data-hover-z="1" data-animated href="category.php?c_id=<?php echo $c_id;?>">Enroll Course</a>
        ...
        <div class="col-md-3">
          <div class="page-section">
              <h1 class="text-display-1 margin-none">Search...</h1>
            </div>
          <div class="page-section">
