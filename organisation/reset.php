...
if (isset($_POST["passwordchange"])) {
	...
	if($num==1) 
	{
		$query = "UPDATE `user` SET password ='$newpwd',reset='' WHERE u_id ='$verify'";
...
$key = $_GET['key'];
	...
	$var_key_db = md5($email);
            ...
            <div class="container-fluid">
              ...
              <div class="lock-container">
                <div class="panel panel-default text-center paper-shadow" data-z="0.5">                  
                  ...
                  <h4 class=" text-center margin-bottom-none">Reset Password</h4>
		...
		echo  "<script> 
					alert('Sorry, You have wrong Password Reset Link Please Signup.');
					window.location.href='logout.php'; 
			   </script>";
