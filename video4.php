...
<body>
  ...
  <div class="container">
    ...
    <div class="page-section" style="padding:5px 0px;">
    	<div class="row">
        	<h1><img src="images/icons/exeal.jpg" height="50" /> &nbsp;&nbsp;Microsoft Excel Part 1</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
           ...
           <ul class="list-group"  style="max-height:400px; overflow-y: scroll;">
			  ...
			  <?php
                	$query = "SELECT * FROM `video` where cat_id = '$cat_id'";	
					$sql = mysqli_query($conn,$query);
					$i =1;
					while($result= mysqli_fetch_array($sql)){
              ...
              <li class="list-group-item">
                <a href="#" class="text-light"><i class="fa fa-play-circle fa-fw"></i><?php echo $i++."&nbsp;".$v_name; ?></a>
              </li>
              <?php
                	}
				?>
                      ...
                      <li class="list-group-item media v-middle">
                        <div class="media-left">
                          <div class="icon-block half img-circle bg-grey-300">
                            ...
                            if($profile_pic != ""){
                            ?>
                            <img src="images/profile/<?php echo $profile_pic;?>" class="img-circle width-50" />
                            <?php					
                            }
                            ?>
