...
<style>
            ...
            .rating:not(:checked) > label:hover ~ label { color: #ef6c00;  }
            ...
            .rating1:not(:checked) > label:hover ~ label { color: #ef6c00;  }

            .rating1 > input:checked + label:hover, 
            .rating1 > input:checked ~ label:hover,
            .rating1 > label:hover ~ input:checked ~ label, 
            .rating1 > input:checked ~ label:hover ~ label { color: #ef6c00;  }     
  ...
  <div class="container">
    	...
    	<div class="row">
        	...
        	<h1>
            	<span style="float:left; padding-left:10px;" class="">
                        <img src="images/icons/<?php echo $cat_icon; ?>" height="70" alt="<?php echo $cat_name; ?>" title="<?php echo $cat_name; ?>" style="text-align:center;">
            ...
            <span class="col-md-4 pull-right <?php if(!isset($_SESSION['id']) && $_SESSION['id']==''){ echo "hidden";} ?>" style="margin-top:10px;">
            <!--rating start-->
                    ...
                    <fieldset id='demo1' class="rating" style="float:right;">
                        <input class="stars" type="radio" id="star5" name="rating" value="5" <?php if($intCountRate == 5){ echo "checked";}?>/>
                        <label class = "full" for="star5" title="Awesome - 5 stars"></label>
                        <input class="stars" type="radio" id="star4" name="rating" value="4" <?php if($intCountRate == 4){ echo "checked";}?>/>
                        <label class = "full" for="star4" title="Pretty good - 4 stars"></label>
                        <input class="stars" type="radio" id="star3" name="rating" value="3" <?php if($intCountRate == 3){ echo "checked";}?>/>
                        <label class = "full" for="star3" title="Meh - 3 stars"></label>
                        <input class="stars" type="radio" id="star2" name="rating" value="2" <?php if($intCountRate == 2){ echo "checked";}?>/>
                        <label class = "full" for="star2" title="Kinda bad - 2 stars"></label>
                        <input class="stars" type="radio" id="star1" name="rating" value="1" <?php if($intCountRate == 1){ echo "checked";}?>/>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
			...
			if($profile_chk_num >= 1 && isset($_SESSION['id']) && isset($_GET['v_id'])){
			...
			else if($profile_chk_num == 0 && isset($_SESSION['id']) && isset($_GET['v_id'])){
			?>
            <script src="https://f.vimeocdn.com/js/froogaloop2.min.js"></script>
         	<iframe id="player1" src="https://player.vimeo.com/video/<?php echo $v_url;?>?api=1&player_id=player1&autoplay=1"
                    width="100%" height="430" data-seek="false" frameborder="0" webkitallowfullscreen mozallowfullscreen
        ...
        <div class="col-md-4">
           ...
           <ul class="list-group"  style="max-height:400px;min-height: 430px;background-color: #FFFFFF; overflow-y: scroll;">
               <li class="list-group-item" style="text-align:center;">
                <h4> <?php echo $curriculum_translate;?></h4>
              </li>
			  <?php
				  
                	$query = "SELECT * FROM `video` WHERE cat_id = '$cat_id' LIMIT 0,500";	
					$sql = mysqli_query($conn,$query);
					$i =0;
                ...
                <li class="list-group-item  ">
				  <a href="syllabus.php?c_id=<?php echo $cat_id;?>" class="text-light <?php echo $strClass;?>"><i class="fa fa-play-circle fa-fw"></i><?php echo "&nbsp;".$v_name.($v_duration!=''?'('.$v_duration.')':'');  $i++ ;?></a>
              </li>
				<?php
                }				
				else{
				?>
                <li class="list-group-item  ">
				  <a href="#" rel="<?php echo $cat_id;?>" data="syllabus.php?c_id=<?php echo $cat_id;?>&v_id=<?php echo $v_id;?>" onClick="checkLogin(this);" class="text-light <?php echo $strClass;?>"><i class="fa fa-play-circle fa-fw"></i><?php echo $i++."&nbsp;".$v_name.($v_duration!=''?'('.$v_duration.')':''); ?></a>
              </li>
				<?php
				}
				?>
        ...
        <div class="row">
                <span class="col-md-4">
                  ...
                  <p class="text-caption" style="font-size:16px;">
                    <i class="fa fa-clock-o fa-fw" style="margin:10px 0px; width: 140px; text-align: left;"><?php echo $total_duration_translate;?>:</i><b><?php echo $duration;?>&nbsp;minutes</b>
                  
                    <br/>
                    <i class="fa fa-play fa-fw" style="margin:10px 0px; width: 140px; text-align: left;"><?php echo $total_vid_translate;?>:</i><b><?php echo $vid_num1;?></b>
                ...
                <span class="col-md-4">
                  ...
                  <p class="text-caption" style="font-size:16px;">
                    ...
                    <i class="fa fa-mortar-board fa-fw" style="margin:10px 0px; width: 140px; text-align: left;"><?php echo $author_translate;?>:</i>  <b>Aur Seekho</b>
                     <br/>
                    <i class="fa fa-users fa-fw" style="margin:10px 0px; width: 140px; text-align: left;"><?php echo $avail_lan_translate;?>:</i> <b>Hindi /Gujarati</b>
                    ...
                    <?php if(isset($_SESSION['id']) && $_SESSION['id']!='')
            {
                      ...
                      <i class="fa fa-area-chart  fa-fw" style="margin:10px 0px;"></i> <?php echo $progress_translate;?>:&nbsp;<b><?php echo $check_cor .'/'.$vid_num1;  ?> Videos</b>
                        <div class="progress" style="background-color:#CED3D5;">
                            <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="<?php echo round(($check_cor / $vid_num1) * 100) ;  ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo round(($check_cor / $vid_num1) * 100) ;  ?>%">
                                <span class="sr-only" style="position: relative; margin-bottom: 2px;"><?php echo round(($check_cor / $vid_num1) * 100) ;  ?>% Complete (success)</span>
                            </div>
                          </div>
                  <?php
            }else
            {
            ?>	<a href="#" class="btn btn-deep-orange-500 btn-flat paper-shadow relative" data-toggle="modal" data-target="#login">Take Course</a>
            <?php
                  }
                      ?>
        ...
        <div class="col-md-8 col-lg-8">
          ...
          <div class="tabbable tabs-blocks tabs-center-h tabs-primary" style="background-color:#FFFFFF;">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#blocks-home-2" data-toggle="tab"><i class="fa fa-comment"></i> <?php echo $comment_translate;?></a></li>
                      ...
                      <div class="page-section padding-top-none">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                          <div class="panel-heading">
                            <h4 class="text-headline"><?php echo $comment_translate;?></h4>
                          </div>
                          <div class="panel-body">
                            <form>
                      ...
                      <li class="list-group-item media v-middle">
                        <div class="media-left">
                          <div class="icon-block half img-circle bg-grey-300">
                            ...
                            if($profile_pic != ""){
                            ?>
                            <img src="images/profile/<?php echo $profile_pic;?>" class="img-circle width-50 height-50" />
                            <?php					
                            }
                            ?>
                      ...
                      <li class="list-group-item media v-middle" style="border-top:none;">
                        <div class="media-left" style="padding-left:20px;">
                          <div class="icon-block half img-circle bg-grey-300">
                            ...
                            if($profile_pic_sub != ""){
                            ?>
                            <img src="images/profile/<?php echo $profile_pic_sub;?>" class="img-circle width-50" />
                            <?php					
                            }
                            ?>
                        ...
                        <div class="media-body">
                          <h4 class="text-subhead margin-none">
                            <a href="#" class="link-text-color"><?php echo $comment_sub;?></a>
                          </h4>
                          <div class="text-light text-caption">
                            posted by
                            <a href="#">
                              <?php echo $full_name_sub;?></a> &nbsp; | <i class="fa fa-clock-o fa-fw"></i> <?php echo $date_sub;?>
                          </div>
                        </div>
                      </li>                      
                      <?php
...
-->                      </div>                     
			...
			?>
                  <li class="list-group-item media v-middle">
                    ...
                    <div class="media-body">
                      <h4 class="text-subhead margin-none">
                        <a href="syllabus.php?c_id=<?php echo $c_id;?>" class="link-text-color"><?php echo $c_name; ?></a>
                      </h4>
