...
if(isset($_POST['submit']))
{
	...
	if($profile_pic != ""){
		...
		$query .= "`language`='$language',`u_type`='$u_type',`user_limit`='$user_limit',`validity`='$validity',`status`='$status' WHERE  `u_id`= '$u_id'";
...
<head>
	...
	<title>Aur Seekho | User edit</title>
									...
									<div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="u_type" class="form-control"  required>
                                                ...
                                                <option value="admin" <?php if($u_type == "admin"){ echo "selected";}?>>Admin</option>
                                                <option value="vendor" <?php if($u_type == "vendor"){ echo "selected";}?>>Vendor</option>
                                                <option value="user" <?php if($u_type == "user"){ echo "selected";}?>>User</option>
                                            </select>
										</div>
                                        <div class="form-group" id="provinceselect">
											<label>License Allocation :</label>
                                            <input type="number" class="form-control" placeholder="User Limit" name="user_limit" value="<?php echo $user_limit;?>">
										</div> 
                                        <div class="form-group">
