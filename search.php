                        ...
                        <div class="page-section" style="padding:5px 0px;">
                            <div class="col-md-6">
                                <h1 class="text-display-1 margin-none"
                                    style="vertical-align:middle;"><?php echo $search_result_translate; ?></h1>
                            </div>
                                ...
                                <div class="item col-xs-12 col-sm-6 col-lg-3 col-md-3">
                                    <div class="panel panel-default paper-shadow" data-z="0.5">
                                                ...
                                                <?php if (isset($_COOKIE['id'])) {
                                                    ...
                                                    <div class="media-right">
                                                        <div class="progress progress-mini width-100 margin-none">
                                                            <div class="progress-bar progress-bar-deep-orange-300"
                                                                 role="progressbar"
                                                                 aria-valuenow="<?php echo ($intCount / $vid_num) * 100; ?>"
                                        ...
                                        <div class="cover overlay cover-image-full hover">
                                            ...
                                            <a href="category.php?c_id=<?php echo $c_id; ?>"
                                               class="padding-none overlay overlay-full icon-block ">
                      <span class="v-center">
                            <img src="images/icons/<?php echo $c_icon; ?>" width="100%" alt="<?php echo $c_name; ?>"
                                 title="<?php echo $c_name; ?>">
                      </span>
                                            </a>
                ...
                <span class="btn btn-circle btn-deep-orange-500 btn-lg"><i class="fa fa-play"></i></span>
                                        ...
                                        <div class="panel-body">
                                            <p class="text-headline margin-v-0-10"><a
                                                    href="syllabus.php?c_id=<?php echo $c_id; ?>"
                                                    style="font-size:20px;"><?php echo $c_name; ?></a></p>
                                        ...
                                        <div class="panel-body" align="center">
                                            ...
                                            <a class="btn btn-deep-orange-500 btn-flat paper-shadow relative" data-z="0"
                            ...
                            if ($cor_num == 0) {
                                ...
                                <div class="item col-xs-12 col-sm-12 col-lg-12 col-md-12"
                                     style="padding-bottom:250px; position:fixed;">
                        ...
                        <div class="row" align="center">
                            <button class="btn btn-deep-orange-500 btn-flat paper-shadow relative" data-z="0"
                                    data-hover-z="1" onClick="window.history.back();">Go Back
                            </button>
                        </div>
                    </div>
