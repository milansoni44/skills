...
if(isset($_POST['submit']))
{
	...
	if($limit_number < $ulimit || $status == 'deactive'){
		...
		$query ="INSERT INTO `user`(`full_name`, `email`, `mobile`, `u_name`, `password`, `profile_pic`, `language`, `u_type`, `add_by`, `validity`, `status`) VALUES ('$full_name','$email','$mobile','$u_name','$password','$profile_pic','$language','$u_type','$uid','$validity','$status')";
