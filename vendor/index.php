...
include("config.php");
    ...
    if(isset($_POST["submit"]))
	{
		...
		$password = $_POST["password"];
		        ...
		        $query = "Select * from user where u_name = '$u_name' and password ='$password' and u_type = 'vendor'";
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div><img src="assets/images/cover.png" alt="Aur Seekho" title="Aur Seekho" width="100%" /></div>
					...
					<div class="footer text-white">
						&copy; 2016. <a href="#" class="text-white">Aur Seekho</a> by <a href="http://letsenkindle.com" class="text-white" target="_blank">Let's Enkindle.com</a>
					</div>
					<!-- /footer -->
